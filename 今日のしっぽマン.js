...
// 【更新履歴】
// 2025/11/04 初リリース
// 2025/11/07 改変しやすくした&CWの場合を考慮した&画像のみの場合を考慮した

//改変時はここから変えてください！
// クリップID
let clipId = 'aerwlqo1p9'
//ロード中に表示する文字
let loadingUiText = '<center>$[tada.speed=0s $[position.x=1.7 :nowloading:$[position.x=-1.7 :weary_shinobi:]]]</center>'
//ハッシュタグ
let hash_tag = '#今日のしっぽマン'
//投稿ボタンの文字
let note_button_text = 'しっぽマンをTLに投下'
//ここまで
